    ...
    <body>
        ...
        <?php
            ...
            echo "<tr colspan = '5' rowspan = '2' align = 'center'><td colspan = '1'> <img src = 'pizzamafia.jpg' alt = 'Pizza' width = '60' height = '50'></td>
                  <th colspan = '3'> Mafia Pizza </th><td> Date : $dt <br> Time : $ti </td></tr>
                  <tr align = 'center'><td colspan = '2'> Customer Name : <br> $cna </td><td colspan = '2'> Customer Address : <br> $cad </td><td> Customer Phone No : <br> $mob </tr>
